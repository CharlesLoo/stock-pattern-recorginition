...
#SBATCH --time=00:05:00                                         # time allocation, which has the format (D-HH:MM), here set to 1 hour
...
#SBATCH --mail-user=a1699138@student.delaide.edu.au                    # Email to which notification will be sent
...
# bash export PYTHONPATH=$PYTHONPATH:/fast/users/a1699138/pattern_recognition/train_model/models-master/research:/fast/users/a1699138/pattern_recognition/train_model/models-master/research/slim
